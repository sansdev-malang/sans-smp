    ...
    <div class="p-6 space-y-6 max-w-4xl mx-auto text-left">
        ...
        <header class="flex flex-col gap-1 w-full">
            <div class="flex items-center gap-2">
                ...
                <h2 class="text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-50">Edit Data Guru</h2>
            </div>
        ...
        <section class="bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm p-6">
            <form action="{{ route('teachers.update', $teacher->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6 text-xs">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name', $teacher->name) }}" placeholder="Contoh: Drs. Eko Wibowo, M.Pd" required
                    ...
                    <div>
                        ...
                        <input type="email" name="email" value="{{ old('email', $teacher->email) }}" placeholder="Contoh: nama@domain.com" required
                    ...
                    <div>
                        ...
                        <input type="text" name="nuptk_nip_nik" value="{{ old('nuptk_nip_nik', $teacher->nuptk_nip_nik) }}" placeholder="Masukkan nomor identitas pendidik"
                    ...
                    <div>
                        ...
                        <input type="text" name="subject_position" value="{{ old('subject_position', $teacher->subject_position) }}" placeholder="Contoh: Matematika, Fisika, Bahasa Indonesia"
                    ...
                    <div>
                        ...
                        <input type="text" name="employment_status" value="{{ old('employment_status', $teacher->employment_status) }}" placeholder="Contoh: PNS, GTY, Honorer" required
                    ...
                    <div>
                        ...
                        <input type="text" name="zkteco_uid" value="{{ old('zkteco_uid', $teacher->zkteco_uid) }}" placeholder="Dapat dikosongkan terlebih dahulu"
